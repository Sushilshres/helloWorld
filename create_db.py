...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'sshrest4', 'email': 'sshrest4@terpmail.umd.edu', 'first_name': 'Sushil', 'last_name': 'Shrestha',
         'password': generate_password_hash('studentpw2', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
